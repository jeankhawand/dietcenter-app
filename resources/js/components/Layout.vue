<template>
  <v-app>
    ...
    <v-footer absolute padless app inset>
      <v-card class="flex" flat tile>
        <v-card-title class="green">
          ...
          <v-btn
            ...
            dark
            icon
            href="https://www.youtube.com/channel/UC2YlJ0G0L9DTlj-9pSA-BrQ?view_as=subscriber"
            target="_blank"
          >
            <v-icon size="24px" class="fab fa-youtube"></v-icon>
          </v-btn>
          <v-btn class="mx-4" dark icon href="https://linkedin.com/company/kwalka" target="_blank">
            <v-icon size="24px" class="fab fa-linkedin"></v-icon>
          </v-btn>
          <v-btn class="mx-4" dark icon href="https://www.instagram.com/kwalkacom/" target="_blank">
            <v-icon size="24px" class="fab fa-instagram"></v-icon>
          </v-btn>
          <v-btn class="mx-4" dark icon href="https://blog.kwalka.com" target="_blank">
