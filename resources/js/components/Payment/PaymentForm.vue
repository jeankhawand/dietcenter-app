      ...
      <v-flex xs12 sm6 offset-sm3>
        <v-card class="elevation-12">
          ...
          <v-card-text>
            ...
            <v-text-field label="First Name" v-model="firstname" :rules="firstnameRules" required></v-text-field>
            <v-text-field label="Last Name" v-model="lastname" :rules="lastnameRules" required></v-text-field>
            <v-text-field
              label="Phone Number"
              v-model="phonenumber"
            ...
            <v-btn color="primary" @click="pay();overlay = !overlay;" :disabled="!complete">Checkout</v-btn>
            <!--        :disabled='!complete'-->
            <v-overlay :value="overlay">
              <v-icon color="green" size="300">mdi-check-circle</v-icon>
              <v-divider></v-divider>
              <v-btn to="/" color="black" class="white--text">BACK TO SHOP</v-btn>
            </v-overlay>
          </v-card-text>
        </v-card>
      </v-flex>
